...
public class TicTacToe implements ActionListener{
	...
	TicTacToe() {
		...
		// Creating new game and quit buttons
		JButton newGame = new JButton("New Game.");
		JButton quit = new JButton("Quit.");
		
		newGame.setForeground(new Color(158, 0, 0));
		newGame.setBackground(Color.BLACK);
		newGame.setFont(new Font("sans-serif", Font.BOLD, 30));
	
		quit.setForeground(new Color(158, 0, 0));
		quit.setBackground(Color.BLACK);
		quit.setFont(new Font("sans-serif", Font.BOLD, 30));
